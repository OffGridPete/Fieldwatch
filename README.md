...
It was Spectre through 1.2.14. I later learned that name already belonged to another app, so this is the same field tool as Fieldwatch: new name, new application id (`app.fieldwatch`), MIT License. Installing Fieldwatch does not replace Spectre on a phone; it is a separate app.
